...
export function Minicourse() {
    ...
    return (
        <section id="minicursos" className="relative bg-white py-12 md:py-16 pb-20 md:pb-16 flex items-center justify-center flex-col text-center w-full px-4 border-b border-slate-200 overflow-hidden">
