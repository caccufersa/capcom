        ...
        <section className="min-h-screen bg-blue-700/10 w-full flex flex-col items-center justify-center py-22 px-8">
            ...
            <div className="w-full max-w-7xl rounded-xl flex flex-col items-center justify-center p-8 bg-white border border-zinc-300 shadow-md py-12 gap-8">
                <details className="w-full max-w-6xl border-b border-zinc-300">
                    <summary className="flex items-center justify-between pb-4" >Não estudo na UFERSA ou não sou do curso de computação, posso me inscrever no evento?
                        <SlArrowDown size={15} />
                    </summary>
                ...
                <details className="w-full max-w-6xl border-b border-zinc-300">
                    <summary className="flex items-center justify-between pb-4">Posso me inscrever em mais de um minicurso por dia?
                        <SlArrowDown size={15} />
                    </summary>
                ...
                <details className="w-full max-w-6xl border-b border-zinc-300">
                    <summary className="flex items-center justify-between pb-4">Preciso me inscrever no evento na página do SIGAA antes de me inscrever nos minicursos?
                        <SlArrowDown size={15} />
                    </summary>
                ...
                <details className="w-full max-w-6xl border-b border-zinc-300">
                    <summary className="flex items-center justify-between pb-4">Não sei programar, posso ver algum minicurso?
                        <SlArrowDown size={15} />
                    </summary>
                ...
                <details className="w-full max-w-6xl border-b border-zinc-300">
                    <summary className="flex items-center justify-between pb-4">Posso ver algum minicurso ter os pré-requesitos necessários?
                        <SlArrowDown size={15} />
                    </summary>
                    <p className="pb-4">Sim, por sua conta e risco :{')'}</p>
                </details>
                <details className="w-full max-w-6xl border-b border-zinc-300">
                    <summary className="flex items-center justify-between pb-4">
