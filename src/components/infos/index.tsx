        ...
        <section className="flex items-center justify-center flex-col py-24 px-4">
            ...
            <div className="flex gap-18 py-12">
                <div className="flex flex-col items-center justify-center bg-blue-300/20 rounded-xl border border-blue-200 w-68 h-48">
                    <FiCalendar size={38} className="text-blue-950" />
                    <p className="font-bold text-blue-950 md:text-xl text-lg py-2">Quando</p>
                ...
                <div className="flex flex-col items-center justify-center bg-blue-300/20 rounded-xl border border-blue-200 w-68 h-48">
                    <GrLocation size={38} className="text-blue-950" />
                    <p className="font-bold text-blue-950 md:text-xl text-lg py-2">Onde</p>
                ...
                <div className="flex flex-col items-center justify-center bg-blue-300/20 rounded-xl border border-blue-200 w-68 h-48">
                    <FiUsers size={38} className="text-blue-950" />
                    <p className="font-bold text-blue-950 md:text-xl text-lg py-2">Para quem</p>
