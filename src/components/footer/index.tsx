    ...
    return (
        <footer className="bg-gradient-to-l from-blue-900 to-blue-500 flex justify-between w-full lg:h-58 h-128 px-12 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] lg:flex-row flex-col">
            <div className='flex flex-1 items-center justify-center gap-6'>
                <img src={epcLogo} alt="Logo Escola Piloto de Computação" className='lg:w-32 w-22 rounded-full' />
                <img src={caccLogo} alt="Logo Centro Acadêmico de Ciência da Computação" className='lg:w-32 w-22' />
            </div>
