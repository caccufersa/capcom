...
export function Footer() {
    ...
    return (
        <>
        <footer className="bg-gradient-to-l from-blue-900 to-blue-500 flex justify-center items-center w-full lg:h-58 h-128 px-12 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] lg:flex-row flex-col lg:gap-40 gap-8">
            ...
            <div className='flex flex-col items-center justify-center'>
                <h3 className='text-white font-medium md:text-xl text-lg mb-2'>Contatos</h3>
